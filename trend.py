...
# print("train:",mean_squared_error(df_y, pred_rf), mean_squared_error(df_y, pred_lgb))
# print("test:", mean_squared_error(df1["target"], pred_rf_test), mean_squared_error(df1["target"], pred_lgb_test))

plt.figure(figsize=(10,6))
plt.plot(df1["target"], label="Real")
plt.plot(pred_rf_test, label="Pred_rf")
plt.plot(pred_lgb_test, label="Pred_LGB")
plt.legend()
plt.show()